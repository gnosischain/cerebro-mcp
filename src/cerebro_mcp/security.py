...
TOOL_RISK_REGISTRY: dict[str, frozenset[RiskClass]] = {
    ...
    "search_docs": _RO,
    "get_doc_chunk": _RO,
    "get_docs_overview": _RO,
    "get_docs_context": _RO,
    "get_gnosis_chain_docs_context": _RO,
    "get_gnosis_chain_doc_chunk": _RO,
    "resolve_address": _RO,
    "system_status": _RO,
    "get_help": _RO,
    # dbt discovery
    ...
    "load_pools_explorer_section": _AO,
    "load_pools_explorer_datasets": _AO,
    "search_pools_explorer": _AO,
    "load_pools_explorer_entity": _AO,
    "load_pools_token_metadata": _AO,
