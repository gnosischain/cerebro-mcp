...
_VALID_ROLES = {
    ...
    # rpc_state_indexer — no dbt models or semantic coverage; describe_table
    # is their discovery)
    "cow_analyst",
    ...
    def get_agent_persona(role: str) -> str:
        ...
        Args:
            role: One of the standard roles ('analytics_reporter',
                ...
                analytics over governance_db, 'pool_liquidity_analyst' for
                Gnosis DEX pool liquidity — concentrated-liquidity ticks and
                pool reserves — over rpc_state_indexer), the point-in-time
                chain reader ('chain_state_analyst'),
