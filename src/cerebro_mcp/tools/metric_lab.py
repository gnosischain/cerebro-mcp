...
def get_metric_catalog(query: str = "", limit: int = METRIC_CATALOG_LIMIT) -> list[dict[str, Any]]:
    ...
    """
    from cerebro_mcp.semantic_index import score_metric
    from cerebro_mcp.semantic_loader import semantic_runtime
    from cerebro_mcp.tools.semantic import (
...
def _load_dual_tables(
    ...
    *,
    ...
    from cerebro_mcp.semantic_loader import semantic_runtime
    from cerebro_mcp.tools.semantic import _maybe_refresh_semantic
    _maybe_refresh_semantic()
    snapshot = semantic_runtime.snapshot
