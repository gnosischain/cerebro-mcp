.PHONY: build-ui build-ui-report build-ui-token-explorer build-ui-metric-lab build-ui-yield-opportunities build-ui-portfolio build-ui-graph-explorer build-ui-quarterly-review build-ui-contract-explorer install dev test
...
build-ui: build-ui-report build-ui-token-explorer build-ui-metric-lab build-ui-yield-opportunities build-ui-portfolio build-ui-graph-explorer build-ui-quarterly-review build-ui-contract-explorer
