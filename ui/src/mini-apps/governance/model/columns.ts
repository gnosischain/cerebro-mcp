...
export const COLUMN_LABELS: Record<string, string> = {
  ...
  // Treasury (contract: model/treasuryColumns.json).
  token_address: "Token",
  symbol: "Symbol",
  registry_symbol: "Asset",
  asset_key: "Asset key",
  asset_class: "Asset class",
  decimals: "Decimals",
  metadata_status: "Metadata",
  token_class: "Class",
  spam_reason: "Hidden because",
  wallets_holding: "Wallets",
  balance_units: "Balance",
  balance_units_ex_ltd: "Balance (ex-Ltd.)",
  ...
  value_usd: "USD value",
  value_usd_ex_ltd: "USD value (ex-Ltd.)",
  ...
  tokens_held: "Tokens",
  priced_positions: "Priced positions",
  unpriced_positions: "Unpriced positions",
  hidden_positions: "Hidden positions",
  gno_units: "GNO",
  is_ltd: "Gnosis Ltd.",
  chain_id: "Chain",
  bucket: "Month",
  ...
  nav_usd: "Value (USD)",
  nav_usd_ex_ltd: "Value ex-Ltd. (USD)",
...
export const HIDDEN_COLUMNS: Record<string, string[]> = {
  ...
  // Treasury datasets render through their own tables (components/treasury/*),
  // not PaginatedTable, so they need no hidden-column config here.
};
