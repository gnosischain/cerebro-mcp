...
- `tools/visualization/governance_explorer.py`: read-only GnosisDAO governance explorer over Snapshot signaling + forum activity (proposals, votes, voters, forum, GIP/discussion cross-links)
